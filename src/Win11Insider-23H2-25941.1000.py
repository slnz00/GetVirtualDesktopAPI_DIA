...
dump = Dumper(Dumper.Output.FILE, 'Win11Insider-23H2-25941.1000 (Canary)', [twinuipcshell, actxprxy])
...
dump.vftable('IVirtualDesktopNotification', '??_7?$VirtualDesktopNotificationForwarderHelper@VCVirtualDesktopNotifications@@@@6BIVirtualDesktopNotification@@@')
dump.vftable('IVirtualDesktopNotificationService', '??_7CVirtualDesktopNotificationsDerived@@6B@')
